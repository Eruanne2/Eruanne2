...
🛠️ Right now I'm wrapping up a Time Value of Money Visualizer, as well as a weather alert system to text my husband when there are significant weather events in certain area. I'm thinking of adding a backend to the weather alert system so that others can sign up as well. 
